...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
							...
							<div class="4u 12u(medium)">
								...
								<!-- Box -->
									<section class="box feature">
										...
										<div class="inner" style="height:500px; border: thin solid #5D7B9D">
											<header><div style="text-align:center">
												<h2 style="color: #000000">Payments</h2>
											</div></header>
							...
							<div class="4u 12u(medium)">
								...
								<!-- Box -->
									<section class="box feature">
										...
										<div class="inner" style="height:500px; border: thin solid #5D7B9D">
											<header><div style="text-align:center">
												<h2 style="color: #000000">Medical Exams</h2>
											</div></header>
											<p style="color: #000000">
							...
							<div class="4u 12u(medium)">
								...
								<!-- Box -->
									<section class="box feature">
										...
										<div class="inner" style="height:500px; border: thin solid #5D7B9D">
											<header><div style="text-align:center">
												<h2 style="color: #000000">Laboratories</h2>
											</div></header>
											<p style="color: #000000">
			...
			<!-- Main -->
				<div id="main-wrapper" style="border: thin solid #5D7B9D">
					<div class="container">
						<div class="row 200%">
							<div class="4u 12u(medium)">
							...
							<div class="8u 12u(medium) important(medium)">
								...
								<!-- Content -->
									<div id="content">
										<section class="last">
											<h2 style="color: #000000">Who are we?</h2>
											<p style="color: #000000">We are called <strong>GuAnalysis</strong>, a free and flourishing website 
