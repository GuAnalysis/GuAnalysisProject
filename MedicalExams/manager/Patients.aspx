...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
      ...
      <asp:Panel ID="panelInfo" runat="server" Visible="false">
        ...
        <div style="margin:1em;margin-left:70ex">
            <asp:Button ID="btClose" runat="server" Text="OK" BackColor="#5D7B9D" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Font-Names="Arial" Font-Size="Small" Font-Underline="False" OnClick="btClose_Click" style="left: 2px; top: -3px" />
        </div>
      </asp:Panel>
      ...
      <asp:Panel ID="panelGridPatients" runat="server">
        ...
        <asp:Panel ID="panelSearch" runat="server" Height="150px" Width="300px" Visible="False">
            ...
            <table>
                <tr>
                    <td style="width: 150px;"><b>Patient Name:</b></td>
            ...
            <table>
                <tr>
                    <td><asp:Button ID="btPerformSearch" runat="server" Text="Search" BackColor="#5D7B9D" BorderColor="Black" BorderStyle="Solid" Font-Names="Arial" Font-Size="Small" Font-Strikeout="False" Height="40px" BorderWidth="1px" style="left: 2px; top: 1px" /></td><td>&nbsp;</td>
                    <td><asp:Button ID="btCloseSearch" runat="server" Text="Search and close" BackColor="#5D7B9D" BorderColor="Black" BorderStyle="Solid" Font-Names="Arial" Font-Size="Small" Font-Strikeout="False" Height="40px" BorderWidth="1px" OnClick="btCloseSearch_Click" Width="170px" style="left: -1px; top: 0px" /></td><td>&nbsp;</td>
                    <td><asp:Button ID="btClearSearch" runat="server" Text="Clear search" BackColor="#5D7B9D" BorderColor="Black" BorderStyle="Solid" Font-Names="Arial" Font-Size="Small" Font-Strikeout="False" Height="40px" BorderWidth="1px" OnClick="btClearSearch_Click" style="left: -3px; top: 1px" /></td>
                </tr>
            </table>
        ...
        <div style="margin-left:30ex; margin-right:auto">
      ...
      <asp:Panel ID="panelDeletePatient" runat="server" BackColor="#FFCC99" Visible="False">
        ...
        <div style="margin: 1em; margin-left:67ex;">
            <asp:Button ID="btConfirmDelete" runat="server" Text="Yes, remove." BackColor="#5D7B9D" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Font-Names="Arial" Font-Size="Small" OnClick="btConfirmDelete_Click" style="left: -1px; top: 1px" />
            <asp:Button ID="btCancelDelete" runat="server" Text="No, cancel." BackColor="#5D7B9D" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Font-Names="Arial" Font-Size="Small" OnClick="btCancelDelete_Click" style="left: 1px; top: 1px" />
        </div>
      </asp:Panel>
                    ...
                    <EditItemTemplate>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="healthNumberTextBox" runat="server" Text='<%# Bind("Health_Number") %>' BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="35px"/>
                                </td>
                                <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorHealthNumber" runat="server" ErrorMessage="Invalid Health Number" ValidationExpression="[0-9]{9}" ControlToValidate="healthNumberTextBox" Display="Dynamic">*</asp:RegularExpressionValidator>
                            ...
                            <tr>
                                <td><b>Name:</b></td>
                                <td>
                                    <asp:TextBox ID="patientNameTextBox" runat="server" Text='<%# Bind("Patient_name") %>' BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="35px"/>
                                </td>
                                <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorEmail" runat="server" ErrorMessage="Invalid e-mail" ClientIDMode="Inherit" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="TextBoxEmail">*</asp:RegularExpressionValidator>
                            ...
                            <tr>
                                <td><b>Address:</b></td>
                                <td>
                                    <asp:TextBox ID="addressTextBox" runat="server" Text='<%# Bind("Patient_address") %>' BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="35px" OnTextChanged="addressTextBox_TextChanged" />
                                </td>
                                <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorAddress" runat="server" ErrorMessage="Address is required." ToolTip="Address is required." Text="*" Display="Dynamic" ControlToValidate="addressTextBox" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="postalCodeTextBox" runat="server" Text='<%# Bind("Postal_code") %>' BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="35px"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBoxBirthDate" runat="server" Text='<%# Bind("Birth_date", "{0:d}") %>' BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="35px"/>
                            ...
                            <td><b>Phone:</b></td>
                                <td>
                                    <asp:TextBox ID="phoneText" runat="server" Text='<%# Bind("Patient_Phone") %>' BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="35px"/>
                                </td>
                                <td>
                      ...
                      <asp:RegularExpressionValidator ID="RegularExpressionValidatorPatientName" runat="server" ErrorMessage="Invalid name must be string" ValidationExpression="^[A-Za-z\s]{1,}[\.]{0,1}[A-Za-z\s]{0,}$" ControlToValidate="patientNameTextBox" Display="Dynamic">*</asp:RegularExpressionValidator>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorEmail" runat="server" ErrorMessage="Invalid e-mail" ClientIDMode="Inherit" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="TextBoxEmail">*</asp:RegularExpressionValidator>
                            ...
                            <tr>
                                <td><b>Address:</b></td>
                                <td>
                                    <asp:TextBox ID="addressTextBox" runat="server" Text='<%# Bind("Patient_address") %>' BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="35px"/>
                                </td>
                               <td>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidatorAddress" runat="server" ErrorMessage="Address is required." ToolTip="Address is required." Text="*" Display="Dynamic" ControlToValidate="addressTextBox" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                   </td>
